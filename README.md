...
- 🛒 Управление заказами
- 💬 Интеграция с Telegram для общения с клиентами
- 👨‍💼 Управление операторами (только для администраторов)
- 📊 Дашборд со статистикой
- 📱 Список активных чатов с быстрым доступом к Telegram
- 📈 Детальная статистика и аналитика (заказы, товары, клиенты, сообщения)
...
│       │   ├── statistics/     # Страница статистики и аналитики
│       │   ├── home/           # Главная страница с активными чатами
...
- **Список активных чатов** - все активные диалоги с клиентами на главной странице
- **Быстрый доступ** - кнопка "Открыть в Telegram" для каждого чата
- **Информация о клиенте** - имя, Telegram ID, телефон, время последней активности
- **Прямая коммуникация** - операторы отвечают клиентам напрямую в Telegram
- **Уведомления** - все уведомления приходят в Telegram
...
- [OPERATOR_GUIDE.md](OPERATOR_GUIDE.md) - Инструкция для операторов
- [STATISTICS_GUIDE.md](STATISTICS_GUIDE.md) - Руководство по статистике
- [STATISTICS_CHARTS.md](STATISTICS_CHARTS.md) - Графики и диаграммы
- [RESTART_SERVICES.md](RESTART_SERVICES.md) - Перезапуск сервисов
